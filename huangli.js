      ...
      { type: 'spacer', length: 6 }, 
      {
        ...
        children: [
          // 🌟 极致缩小的左侧日期卡片
          {
            ...
            borderRadius: 8,            // ⬇️ 修改: 圆角变小 (10 -> 8)，更适合小尺寸
            padding: [2, 6],            // ⬇️ 修改: 内边距大幅缩小 (纵向2，横向6)
            children: [
              { type: 'text', text: `周${WEEK}`, font: { size: 9, weight: 'bold' }, textColor: C.holiday, maxLines: 1 },    // ⬇️ 修改: 星期字号减小 (10 -> 9)
              { type: 'spacer', length: 1 },
              { type: 'text', text: `${D}`, font: { size: 16, weight: 'heavy', family: 'rounded' }, textColor: C.main, maxLines: 1 }, // ⬇️ 修改: 主体公历日期大幅缩小 (22 -> 16)
              { type: 'spacer', length: 1 },
              { type: 'text', text: obj.cn, font: { size: 9, weight: 'bold' }, textColor: C.gold, maxLines: 1 }      // ⬇️ 修改: 农历字号减小 (10 -> 9)
            ]
          },
          {
